...
return array(
    'Altis\\Autoloader' => $vendorDir . '/altis/core/inc/class-autoloader.php',
    'Altis\\CMS\\Composer\\Plugin' => $vendorDir . '/altis/cms-installer/inc/composer/class-plugin.php',
    'Altis\\Composer\\Installer' => $vendorDir . '/altis/core/inc/composer/class-installer.php',
    'Altis\\Composer\\Plugin' => $vendorDir . '/altis/core/inc/composer/class-plugin.php',
    'Altis\\Dev_Tools\\Altis_Config\\QM_Collector_Altis_Config' => $vendorDir . '/altis/dev-tools/inc/altis_config/class-qm-collector-altis-config.php',
    'Altis\\Dev_Tools\\Altis_Config\\QM_Output_Html_Altis_Config' => $vendorDir . '/altis/dev-tools/inc/altis_config/class-qm-output-html-altis-config.php',
    'Altis\\Dev_Tools\\Command\\Command' => $vendorDir . '/altis/dev-tools-command/inc/command/class-command.php',
    'Altis\\Dev_Tools\\Command\\Command_Provider' => $vendorDir . '/altis/dev-tools-command/inc/command/class-command-provider.php',
    'Altis\\Dev_Tools\\Command\\Plugin' => $vendorDir . '/altis/dev-tools-command/inc/command/class-plugin.php',
    'Altis\\Documentation\\Group' => $vendorDir . '/altis/documentation/inc/class-group.php',
    'Altis\\Documentation\\MarkdownParser' => $vendorDir . '/altis/documentation/inc/class-markdownparser.php',
    'Altis\\Documentation\\Page' => $vendorDir . '/altis/documentation/inc/class-page.php',
    'Altis\\Local_Chassis\\Command' => $vendorDir . '/altis/local-chassis/inc/class-command.php',
    'Altis\\Local_Chassis\\CommandProvider' => $vendorDir . '/altis/local-chassis/inc/class-commandprovider.php',
    'Altis\\Local_Chassis\\ComposerPlugin' => $vendorDir . '/altis/local-chassis/inc/class-composerplugin.php',
    'Altis\\Local_Server\\Composer\\Command' => $vendorDir . '/altis/local-server/inc/composer/class-command.php',
    'Altis\\Local_Server\\Composer\\Command_Provider' => $vendorDir . '/altis/local-server/inc/composer/class-command-provider.php',
    'Altis\\Local_Server\\Composer\\Plugin' => $vendorDir . '/altis/local-server/inc/composer/class-plugin.php',
    'Altis\\Module' => $vendorDir . '/altis/core/inc/class-module.php',
